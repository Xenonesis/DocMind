-- Safe DocMind Schema for Supabase (won't fail if objects exist)
...
BEGIN
    IF NOT EXISTS (
        ...
        WHERE conname = 'ai_provider_settings_user_id_provider_name_key'
    ) THEN
        ALTER TABLE public.ai_provider_settings 
        ADD CONSTRAINT ai_provider_settings_user_id_provider_name_key 
...
DROP POLICY IF EXISTS "Users can manage own AI settings" ON public.ai_provider_settings;
