...
export const metadata: Metadata = {
  ...
  description:
    'AI-powered document processing system with semantic search and natural language queries.',
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning data-scroll-behavior="smooth">
      <body
        className={`antialiased bg-background text-foreground ${bricolage.variable} ${spaceMono.variable} font-sans`}
      >
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
