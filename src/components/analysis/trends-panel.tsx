    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <Card className="border border-border shadow-sm">
        ...
        <CardContent className="p-5">
          {!analysisStats?.queriesPerDay ||
          analysisStats.queriesPerDay.every((d) => d.count === 0) ? (
      ...
      <Card className="border border-border shadow-sm md:col-span-2">
        ...
        <CardContent className="p-5">
          {!analysisStats?.topDocuments ||
          analysisStats.topDocuments.every((d) => d.queries === 0) ? (
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between text-xs mb-1">
                          ...
                          <span className="text-muted-foreground ml-2 shrink-0">
                            {doc.queries} {doc.queries === 1 ? 'query' : 'queries'}
                          </span>
                        </div>
                        <div className="h-1.5 bg-secondary rounded-full overflow-hidden">
                          <div
