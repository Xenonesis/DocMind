      ...
      >
                  ...
                  <div className="space-y-1.5">
                    {message.highlights.slice(0, 4).map((item, idx) => (
                      <div
                        ...
                        className="rounded-md border border-amber-300/40 bg-amber-50/80 dark:bg-amber-900/20 px-2.5 py-1.5"
                      >
                  ...
                  <div className="space-y-1.5">
                    {message.references.slice(0, 3).map((ref, idx) => (
                      <div
                        ...
                        className="rounded-md border border-border/70 bg-background/60 px-2.5 py-1.5"
                      >
        ...
        <div className={`flex items-center gap-2 px-1 ${isUser ? 'flex-row-reverse' : 'flex-row'}`}>
          ...
          {message.docsUsed && message.docsUsed.length > 0 && (
            <Badge
              variant="outline"
              className="text-[10px] h-4 px-1.5 font-normal border-border/50 text-muted-foreground/70 gap-1"
            >
